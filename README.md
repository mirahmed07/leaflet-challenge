...
### Notes
* A `static` folder contains a CSS file and in image file with the screenshot. The user need to manually updated the `config.js` file in `static/js/` directory with MapBox API key. This is **required** to be able to view the visualization.
